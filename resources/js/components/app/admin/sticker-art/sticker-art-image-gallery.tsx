...
import StickerArtImageDialog from './sticker-art-image-dialog';
...
interface StickerImageGalleryProps {
    images: ImageItem[];
...
export default function StickerImageGallery({ images, onImageUpload, onImageDelete, isEditing }: StickerImageGalleryProps) {
        ...
        <div className="space-y-4">
            <div className="flex flex-wrap gap-4">
                {images.map((image, index) => (
                    ...
                    >
                        <img src={image.url} alt={`Sticker image ${index + 1}`} className="h-full w-full object-cover" />
                        {image.is_primary && (
