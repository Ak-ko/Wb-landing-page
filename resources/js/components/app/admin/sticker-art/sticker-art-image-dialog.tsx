...
interface StickerArtImageDialogPropsT {
    open: boolean;
    onClose: () => void;
    image?: {
        id?: number | string;
...
export default function StickerArtImageDialog({ open, onClose, image, onDelete, onUpload, isEditing }: StickerArtImageDialogPropsT) {
