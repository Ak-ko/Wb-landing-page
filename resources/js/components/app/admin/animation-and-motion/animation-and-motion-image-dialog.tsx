...
interface AnimationAndMotionImageDialogPropsT {
    open: boolean;
    onClose: () => void;
    image?: {
        id?: number | string;
...
export default function AnimationAndMotionImageDialog({ open, onClose, image, onDelete, onUpload, isEditing }: AnimationAndMotionImageDialogPropsT) {
    ...
    return (
        <Dialog open={open} onOpenChange={(open) => !open && handleCancel()}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>{selectedFile ? 'Upload New Video' : image?.id ? 'Manage Video' : 'Add New Video'}</DialogTitle>
                </DialogHeader>
