...
interface IllustrationImageDialogProps {
    open: boolean;
    onClose: () => void;
    image?: {
        id?: number | string;
...
export default function IllustrationImageDialog({ open, onClose, image, onDelete, onUpload, isEditing }: IllustrationImageDialogProps) {
