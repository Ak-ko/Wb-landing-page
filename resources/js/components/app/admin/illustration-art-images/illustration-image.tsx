...
import IllustrationImageDialog from './illustration-image-dialog';
...
interface IllustrationImageGalleryProps {
    images: ImageItem[];
...
export default function IllustrationImageGallery({ images, onImageUpload, onImageDelete, isEditing }: IllustrationImageGalleryProps) {
        ...
        <div className="space-y-4">
            <div className="flex flex-wrap gap-4">
                {images.map((image, index) => (
                    ...
                    >
                        <img src={image.url} alt={`Illustration image ${index + 1}`} className="h-full w-full object-cover" />
                        {image.is_primary && (
