        ...
        <section className="py-16">
            <div className="app-container">
                ...
                <div className="grid grid-cols-1 gap-5 py-10 md:px-15 lg:grid-cols-2 xl:px-30">
                    {/* New Business Card */}
                    <div className="relative space-y-8 rounded-4xl bg-[#F5F5F5] p-9 shadow transition-all duration-500 hover:shadow-lg hover:shadow-[#1CB3CE50]">
                    ...
                    <div className="hover:shadow-chillie-red/20 relative space-y-8 rounded-4xl bg-[#F5F5F5] p-9 shadow transition-all duration-500 hover:shadow-lg">
