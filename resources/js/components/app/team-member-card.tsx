            ...
            <div className={cn('flex items-center justify-center gap-5', varient === 'compact' ? 'flex-col' : 'flex-col lg:flex-row')}>
                ...
                <div className="relative flex shrink-0 flex-col">
                    <img
                        ...
                        className={cn(
                            'invisible absolute left-1/2 h-full w-full -translate-x-1/2 -translate-y-[100px] scale-0 object-cover opacity-0 transition-all duration-500 group-hover:visible group-hover:translate-y-0 group-hover:scale-[1] group-hover:opacity-100',
