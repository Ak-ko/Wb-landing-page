            ...
            <tbody className="block">
                {businessPackageAddons.map((addon, indx) => (
                    <motion.tr
                        ...
                        key={addon?.id}
                        className="my-2 block w-full space-x-3"
                    >
                        <td className="inline-block w-[48%] rounded-2xl bg-gray-100 p-3 text-start font-bold text-black sm:w-[55%]">{addon?.name}</td>
                        <td className="inline-block w-[48%] rounded-2xl bg-gray-100 p-3 text-end font-bold text-black sm:w-[42%]">
