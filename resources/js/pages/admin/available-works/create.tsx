...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create',
        href: '/admin/available-works/create',
    },
];
...
export default function Create() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('available-works.store'));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Available Work" />
            <div className="space-y-6 p-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Create Available Work</h1>
                        <p className="text-muted-foreground">Add a new available work to the marquee section.</p>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex gap-4">
                                <Button type="submit" disabled={processing}>
                                    {processing ? 'Creating...' : 'Create Available Work'}
                                </Button>
                                <Link href={route('available-works.index')}>
